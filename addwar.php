...
move_uploaded_file($_FILES['image']['tmp_name'], $path);
  ...
  $add="insert into war(title,description,address,date,image) values('$title','$description','$address','$date','$path1')";        
  $result=mysqli_query($conn,$add) or die(mysqli_error($conn));
  if($result)
  {
    echo "<script>";
    echo "alert('Inserted Successfully..!');";
    echo "window.location.href='viewwar.php';";
    echo "</script>";
  }
  else
  {
            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="date" name="address">
                    </div>
                    <div class="mb-3">
